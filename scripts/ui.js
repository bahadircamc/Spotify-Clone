//arayuz fonksiyonlari bu kisimda yazilacak



export default class UI {
    //htmlden cagirdimiz arayuz elementleri
    constructor(){
    ...
    //ekrana kartlari basar
    renderCards(songs){
        //list elemanini bosaltarak tekrar doldurmak icin(loaderi yok etttik)
        this.list.innerHTML = "";

        //gelen listedeki her bir musik icin bir card olusturup ekrana bas
        songs.forEach((song) => {
            const div = document.createElement("div");
            div.className = "card";

            // kart elemanina muzik bilgilerini dataset olarak ekle
        ...
        <div class="loader">
            <div class="audio-player">
                <div class="top">
                  ...
                  <div class="texts">
                    <p class="title-1">Spotify</p>
                    <p class="title-2">Loader...</p>
                  </div>
                </div>
    ...
    renderPlayer(song){
      ...
      //audio elementini al ve play-pause olmasini izle bu eylemler sirasinda toggleAnimation fonksiyonunu calistir.
    ...
    //animasyon yoksa eklesin varsa kaldirsin
    toggleAnimation(){
